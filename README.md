...
Elle couvre les cas qui comptent : champs vides, champ déjà rempli (le texte existant doit survivre), champ verrouillé, texte enrichi, un champ dans un cadre séparé, deux champs au même libellé, et un champ « Allergies » contenant une négation — si le rapport mentionne une allergie, elle doit être ajoutée, jamais ignorée.
